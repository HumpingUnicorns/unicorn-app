...
export default function TwitterIntent(){
    return(
        ...
        <button 
            ...
            onClick={() => window.open("https://twitter.com/intent/tweet?url=https://house.humpingunicorns.com/&text=I%20just%20sent%20my%20Unicorns%20to%20the%20Hump%20House%21%0A%0AHopefully%20they'll%20have%20a%20Fling%20and%20bring%20home%20a%20friend!", "_blank")}
        >
            <img 
