    ...
    return(
        ...
        <div className='w-full h-full overflow-hidden bg-[#6e7cc4b1] border-2 border-white rounded-xl'>
            ...
            <div className='mt-4 mb-4'>
                <span className='w-full text-pink-200 text-center font-text lg:text-sm sm:text-sm px-4' style={{ borderTop: '0.5px solid white', borderBottom: '0.5px solid white', display: 'block', padding: '8px 0' }}>FAVE POSITION: ?</span>
            </div>
            </div>
        </div>               
    </div> 
