    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-center items-center mt-6'>
                <h2 className={`flex justify-center border-solid drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] text-[#f3f3f3] text-8xl font-text font-bold mt-4 mb-4`}>Welcome
                    to the Unicorn Humping</h2>
            ...
            <div
                ...
                <div style={{ borderRadius: 600 }}
                    ...
                    <p className={`flex justify-center w-full font-spegiel  text-xxs md:text-sm lg:text-xl xl:text-4xl`}>Total
                        humping</p>
                ...
                <div style={{ borderRadius: 600 }}
                    className={`flex flex-col justify-center pl-2 pr-2 pt-6 pb-6 w-3/5 text-white border-4 border-[#F880C2] bg-[#414A78] shadow-2xl shadow-[#414A78]`}>
                    <p className={`flex justify-center w-full font-spegiel  text-xxs md:text-sm lg:text-xl xl:text-4xl`}>Day
                        until</p>
